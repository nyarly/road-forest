class RoadForest::RDF::SourceRigor
  module Credence
    require 'road-forest/rdf/source-rigor/credence/role-if-available'
    require 'road-forest/rdf/source-rigor/credence/any'
    require 'road-forest/rdf/source-rigor/credence/none-if-role-absent'
